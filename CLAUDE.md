...
- **Execution provider:** XNNPACK as default for FP32, CPU for INT8, NNAPI selectable via UI toggle (all three: CPU, XNNPACK, NNAPI). NNAPI uses `NNAPI_FLAG_CPU_DISABLED` on API 29+ to force NPU; falls back to XNNPACK/CPU on failure
